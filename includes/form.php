    ...
    function my_action_callback() {
       ...
       // exit;
        ...
        if( ! empty( $_POST )){
            ...
            global $wpdb;
            /*check dublicate
            $emailfromdb = "SELECT * FROM repairman WHERE email = $email" ;

            $wresults = $wpdb->get_row("$SELECT * FROM repairman WHERE email = $email") ;echo $wpdb->last_error;
echo $wresults;
            if ( $wresults ) {
